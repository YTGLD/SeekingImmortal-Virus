...
public class nightmare_giant extends MoonTamableAnimal implements OwnableEntity,VibrationSystem {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH, 150).add(Attributes.MOVEMENT_SPEED, 0.3F).add(Attributes.KNOCKBACK_RESISTANCE, 1.0D).add(Attributes.ATTACK_KNOCKBACK, 1.5D).add(Attributes.ATTACK_DAMAGE, 15);
    }
    ...
    class VibrationUser implements VibrationSystem.User {
        ...
        public boolean canReceiveVibration(ServerLevel p_282574_, BlockPos p_282323_, Holder<GameEvent> p_316784_, GameEvent.Context p_282515_) {
            if (!nightmare_giant.this.isNoAi()
                ...
                return !(p_282515_.sourceEntity() instanceof LivingEntity livingentity) || nightmare_giant.this.canTargetEntity(livingentity);
            } else {
                return false;
            }
        }
