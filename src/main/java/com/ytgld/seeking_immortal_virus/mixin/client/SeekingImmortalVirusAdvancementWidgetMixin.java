...
import com.ytgld.seeking_immortal_virus.client.renderer.WidgetTypes;
...
public class SeekingImmortalVirusAdvancementWidgetMixin implements IAdvancementWidget {
    ...
    @Override
    public void SeekingImmortalVirusseekingImmortals$draw(GuiGraphics guiGraphics, int x, int y) {
        ...
        for (AdvancementWidget advancementwidget : this.children) {
            if (advancementwidget instanceof IAdvancementWidget advancementWidget) {
                advancementWidget.SeekingImmortalVirusseekingImmortals$draw(guiGraphics, x, y);
            }
        }
    ...
    @Override
    public void SeekingImmortalVirusseekingImmortals$drawHover(GuiGraphics guiGraphics, int x, int y, float fade, int width, int height) {
