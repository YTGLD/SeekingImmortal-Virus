...
public class MGuiGraphics {
    ...
    private static void blit(GuiGraphics guiGraphics, ResourceLocation p_282639_, float p_282732_, float p_283541_, float p_281760_, float p_283298_, float p_283429_, float p_282193_, float p_281980_, float p_282660_, float p_281522_, float p_282315_, float p_281436_, float r, float g, float b, float a) {
        blit(guiGraphics, p_282639_, p_282732_, p_283541_, p_281760_, p_283298_, p_283429_, (p_282660_ + 0.0F) / p_282315_, (p_282660_ + p_282193_) / p_282315_, (p_281522_ + 0.0F) / p_281436_, (p_281522_ + p_281980_) / p_281436_, r, g, b, a);
    }
    ...
    private static void blit(GuiGraphics guiGraphics, ResourceLocation texture, float startX, float endX, float startY, float endY, float zLevel, float u0, float u1, float v0, float v1, float r, float g, float b, float a) {
        ...
        bufferbuilder.addVertex(matrix4f, startX, startY, zLevel).setColor(r, g, b, a).setUv(u0, v0);
        bufferbuilder.addVertex(matrix4f, startX, endY, zLevel).setColor(r, g, b, a).setUv(u0, v1);
        bufferbuilder.addVertex(matrix4f, endX, endY, zLevel).setColor(r, g, b, a).setUv(u1, v1);
        bufferbuilder.addVertex(matrix4f, endX, startY, zLevel).setColor(r, g, b, a).setUv(u1, v0);
