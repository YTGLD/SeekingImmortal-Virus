...
public class AttReg {
    ...
    public static final DeferredHolder<Attribute,?> alL_attack = REGISTRY.register("allattack",()->{
        return new RangedAttribute("attribute.name.seeking_immortal_virus.allattack", 1, -1024, 1024).setSyncable(true);
    });
    public static final DeferredHolder<Attribute,?> heal = REGISTRY.register("heal",()->{
        return new RangedAttribute("attribute.name.seeking_immortal_virus.heal", 1, -1024, 1024).setSyncable(true);
    });
    public static final DeferredHolder<Attribute,?> cit = REGISTRY.register("cit",()->{
        return new RangedAttribute("attribute.name.seeking_immortal_virus.cit", 1, -1024, 1024).setSyncable(true);
    });
    public static final DeferredHolder<Attribute,?> dig = REGISTRY.register("dig",()->{
        return new RangedAttribute("attribute.name.seeking_immortal_virus.dig", 1, -1024, 1024).setSyncable(true);
    });
    public static final DeferredHolder<Attribute,?> hurt = REGISTRY.register("hurt",()->{
        return new RangedAttribute("attribute.name.seeking_immortal_virus.res", 1, -1024, 1024).setSyncable(true);
    });

    public static final DeferredHolder<Attribute,?> owner_blood_damage = REGISTRY.register("owner_blood_damage",()->{
        return new RangedAttribute("attribute.name.seeking_immortal_virus.owner_blood_damage", 1, -1024, 1024).setSyncable(true);
    });
    public static final DeferredHolder<Attribute,?> owner_blood_speed = REGISTRY.register("owner_blood_speed",()->{
        return new RangedAttribute("attribute.name.seeking_immortal_virus.owner_blood_speed", 1, -1024, 1024).setSyncable(true);
    });
    public static final DeferredHolder<Attribute,?> owner_blood_time = REGISTRY.register("owner_blood_time",()->{
        return new RangedAttribute("attribute.name.seeking_immortal_virus.owner_blood_time", 1, -1024, 1024).setSyncable(true);
    });
    public static final DeferredHolder<Attribute,?> owner_blood_attack_speed = REGISTRY.register("owner_blood_attack_speed",()->{
        return new RangedAttribute("attribute.name.seeking_immortal_virus.owner_blood_attack_speed", 1, -1024, 1024).setSyncable(true);
    });
